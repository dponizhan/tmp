...
removeButtonDefaults : {
    ...
    getHoverHTML : function () {
        ...
        if (!fb.allowEmpty && fb.clauses.length == 1) return fb.lastClausePrompt;
        return this.prompt;
    }
},
...
getFieldNames : function () {
    ...
    if (this.dataSource) return this.getDataSource().getFieldNames(!this.showHiddenFields);
},
...
createDynamicValueWindow : function (title, fieldName, pathField, valuePath, valueSelected) {
    ...
    this.dynamicValueWindow = this.createAutoChild("dynamicValueWindow", {
        title: title,
        items: [ ruleScopeGrid, isc.HLayout.create({ height: 1, layoutAlign: "right", membersMargin: 10, members: [ cancelButton, okButton ] }) ],
        ruleScopeDS : ds,
