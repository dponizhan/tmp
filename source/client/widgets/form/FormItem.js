...
isc.FormItem.addProperties({
    ...
    // +link{dataSourceField.foreignDisplayField} for more on this.
    // <P>
...
//        this.logWarn("saving value: " + value + this.getStackTrace());
    ...
    _checkForTargetFieldValue : function (newValue, targetField, isValueField) {
        ...
        if (needFetch) {
            ...
            {
                recordCrit = isc.DataSource.convertCriteria(recordCrit, this.optionTextMatchStyle);
            }
            ...
            if (!recordCrit && this.getPickListFilterCriteria && this.optionOperationId) {
                ...
                {
                    recordCrit = isc.DataSource.convertCriteria(recordCrit, this.textMatchStyle);
                }
            }
            ...
            if (!this.filterLocally) {
                ...
                recordCrit = isc.DataSource.combineCriteria(
...
*/
    ...
    parseValueExpressions : function (value, fieldName, operator) {
        ...
        if (operatorObj && operatorObj.symbol == "..." && !value.contains("...")) {
