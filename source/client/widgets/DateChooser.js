...
isc.DateChooser.addMethods({
    ...
    makeButtonLayout : function (props) {
        ...
        for (var i = 0; i < this.buttonLayoutControls.length; i++) {
            ...
            if (isc.isA.Canvas(component)) {
                ...
                liveComponent = this[component] = this.createAutoChild(component, props, this.bottomButtonConstructor);
    ...
    updateHeader : function (weekNum, date) {
        if (!this.showNavigationLayout && this.navigationLayout) {
            ...
            if (this.showWeekChooser) {
                ...
                if (!this.weekChooserButton.isDrawn()) this.weekChooserButton.draw();
            ...
            if (this.showFiscalYearChooser) {
                ...
                if (!this.fiscalYearChooserButton.isDrawn()) this.fiscalYearChooserButton.draw();
    ...
    updateUI : function (weekNum) {
        ...
        if (!this.showTimeItem) {
            ...
            if (this.applyButton) {
                ...
                if (this.timeLayoutIsVisibleWidth || this.timeLayoutIsVisibleMinFieldWidth) {
                    ...
                    this.buttonLayout.setBorder("0px");
        ...
        if (this.dateGrid && this.dateGrid.body && !this.showFullScreen()) {
    ...
    todayClick : function () {
        var date = isc.DateUtil.getAsDisplayDate(new Date());
