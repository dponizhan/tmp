...
if (window.isc && isc.version != "v12.1p_2021-02-17/LGPL Development Only" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v12.1p_2021-02-17/LGPL Development Only'. Mixing resources from different "
    ...
    sortForRender : function (events) {
        ...
        if (cal.overlapSortSpecifiers) {
            ...
            if (!cal.showColumnLayouts) {
                ...
                specifiers.add({ property: "_slotNum", direction: "ascending" });
            }
            specifiers.add({ property: cal.startDateField, direction: "ascending" });
        }
...
isc.TimelineView.addProperties({
    ...
    setChosenDate : function (newDate) {
        ...
        this.logicalDate = newDate.duplicate();
    ...
    getHeaderSpans : function (startDate, endDate, headerLevels, levelIndex, fields) {
        ...
        while (date <= endDate) {
            ...
            if (firstLoop) {
                firstLoop = false;
                var newDate = isc.DateUtil.getEndOf(date.duplicate(), unitKey, false, c.firstDayOfWeek);
            } else {
...
setChosenDate : function (newDate, fromTimelineView) {
    ...
    if (this.timelineView) {
        if (!fromTimelineView) {
            this.timelineView.setChosenDate(newDate);
        }
    } else {
        ...
        items: [
            isc.DynamicForm.create({
                ...
                createFields : function (isEvent) {
                    ...
                    this.setDataSource(dialogDS, isc.shallowClone(this.calendar.eventDialogFields || []));
...
getEventEditorLayout : function () {
    ...
    this.eventEditor = this.createAutoChild("eventEditor", {
        ...
        initWidget : function () {
            ...
            ;
            this.extraWidthForTimePickers = extraWidth;
        ...
        rebuildFieldList : function () {
            ...
            if (editStyle == "date" || editStyle == "datetime") {
                ...
                var baseStyleName = isc.SelectItem.getInstanceProperty("textBoxStyle");
                var extraWidth = this.extraWidthForTimePickers;
            ...
            this.setDataSource(editorDS, fieldsToUse);
...
_showEventEditor : function (event, isNewEvent) {
    ...
    if (this.eventEditor.dateEditingStyle != editingStyle) {
        // if dateEditingStyle is different, recreate the edit-initialize the eventEditor
    ...
    if (event) {
        ...
        editorLayout.setTitle(this.newEventEditorWindowTitle);
        if (this.eventDialog && this.eventDialog.isVisible()) {
